...
const ADJ_STATIC = [
  { de:"gut", en:"good", es:"bueno / buena", fr:"bon / bonne", nl:"goed" },
  { de:"schlecht", en:"bad", es:"malo / mala", fr:"mauvais / mauvaise", nl:"slecht" },
  { de:"groß", en:"big", es:"grande", fr:"grand / grande", nl:"groot" },
  { de:"klein", en:"small", es:"pequeño / pequeña", fr:"petit / petite", nl:"klein" },
  { de:"neu", en:"new", es:"nuevo / nueva", fr:"nouveau / nouvelle", nl:"nieuw" },
  { de:"alt", en:"old", es:"viejo / vieja", fr:"vieux / vieille", nl:"oud" },
  { de:"jung", en:"young", es:"joven", fr:"jeune", nl:"jong" },
  { de:"schön", en:"beautiful", es:"bonito / bonita", fr:"beau / belle", nl:"mooi" },
  { de:"hässlich", en:"ugly", es:"feo / fea", fr:"laid / laide", nl:"lelijk" },
  { de:"lang", en:"long", es:"largo / larga", fr:"long / longue", nl:"lang" },
  { de:"kurz", en:"short", es:"corto / corta", fr:"court / courte", nl:"kort" },
  { de:"hoch", en:"high", es:"alto / alta", fr:"haut / haute", nl:"hoog" },
  { de:"niedrig", en:"low", es:"bajo / baja", fr:"bas / basse", nl:"laag" },
  { de:"einfach", en:"easy", es:"fácil", fr:"facile", nl:"makkelijk" },
  { de:"schwierig", en:"difficult", es:"difícil", fr:"difficile", nl:"moeilijk" },
  { de:"glücklich", en:"happy", es:"feliz", fr:"heureux / heureuse", nl:"gelukkig" },
  { de:"traurig", en:"sad", es:"triste", fr:"triste", nl:"verdrietig" },
  { de:"schnell", en:"fast", es:"rápido / rápida", fr:"rapide", nl:"snel" },
  { de:"langsam", en:"slow", es:"lento / lenta", fr:"lent / lente", nl:"langzaam" },
  { de:"teuer", en:"expensive", es:"caro / cara", fr:"cher / chère", nl:"duur" },
  { de:"billig", en:"cheap", es:"barato / barata", fr:"bon marché", nl:"goedkoop" },
  { de:"heiß", en:"hot", es:"caliente", fr:"chaud / chaude", nl:"heet" },
  { de:"kalt", en:"cold", es:"frío / fría", fr:"froid / froide", nl:"koud" },
  { de:"sauber", en:"clean", es:"limpio / limpia", fr:"propre", nl:"schoon" },
  { de:"schmutzig", en:"dirty", es:"sucio / sucia", fr:"sale", nl:"vuil" },
  { de:"stark", en:"strong", es:"fuerte", fr:"fort / forte", nl:"sterk" },
  { de:"schwach", en:"weak", es:"débil", fr:"faible", nl:"zwak" },
  { de:"reich", en:"rich", es:"rico / rica", fr:"riche", nl:"rijk" },
  { de:"arm", en:"poor", es:"pobre", fr:"pauvre", nl:"arm" },
  { de:"voll", en:"full", es:"lleno / llena", fr:"plein / pleine", nl:"vol" },
  { de:"leer", en:"empty", es:"vacío / vacía", fr:"vide", nl:"leeg" },
  { de:"offen", en:"open", es:"abierto / abierta", fr:"ouvert / ouverte", nl:"open" },
  { de:"geschlossen", en:"closed", es:"cerrado / cerrada", fr:"fermé / fermée", nl:"gesloten" },
  { de:"hell", en:"bright", es:"claro / clara", fr:"clair / claire", nl:"helder" },
  { de:"dunkel", en:"dark", es:"oscuro / oscura", fr:"sombre", nl:"donker" },
  { de:"schwer", en:"heavy", es:"pesado / pesada", fr:"lourd / lourde", nl:"zwaar" },
  { de:"leicht", en:"light", es:"ligero / ligera", fr:"léger / légère", nl:"licht" },
  { de:"wichtig", en:"important", es:"importante", fr:"important / importante", nl:"belangrijk" },
  { de:"interessant", en:"interesting", es:"interesante", fr:"intéressant / intéressante", nl:"interessant" },
  { de:"langweilig", en:"boring", es:"aburrido / aburrida", fr:"ennuyeux / ennuyeuse", nl:"saai" },
  { de:"lustig", en:"funny", es:"divertido / divertida", fr:"drôle", nl:"grappig" },
  { de:"nett", en:"nice", es:"simpático / simpática", fr:"sympathique", nl:"aardig" },
  { de:"freundlich", en:"friendly", es:"amable", fr:"aimable", nl:"vriendelijk" },
  { de:"wütend", en:"angry", es:"enfadado / enfadada", fr:"fâché / fâchée", nl:"boos" },
  { de:"müde", en:"tired", es:"cansado / cansada", fr:"fatigué / fatiguée", nl:"moe" },
  { de:"gesund", en:"healthy", es:"sano / sana", fr:"sain / saine", nl:"gezond" },
  { de:"krank", en:"sick", es:"enfermo / enferma", fr:"malade", nl:"ziek" },
  { de:"trocken", en:"dry", es:"seco / seca", fr:"sec / sèche", nl:"droog" },
  { de:"nass", en:"wet", es:"mojado / mojada", fr:"mouillé / mouillée", nl:"nat" },
  { de:"gefährlich", en:"dangerous", es:"peligroso / peligrosa", fr:"dangereux / dangereuse", nl:"gevaarlijk" }
];
...
function VocabView({ lang }) {
  ...
  function seedAdjectives(catName) {
    ...
    if (code === lang) { persist(seedKey, true); return; } // mother tongue = target → nothing to learn
    const have = getVocab();
    const additions = [];
    ADJ_STATIC.forEach((a, i) => {
      const term = (a[lang] || "").trim(), nat = (a[code] || a.en || "").trim();
      ...
      additions.push({ id: Date.now() + "-adj" + i, lang, term, trans: nat, cat: catName, kind: "word", created: Date.now() + i, seed: true, nat: nativeName });
    });
  ...
  function seedCategory(catName) {
    ...
    if (isAdjTopic(catName)) { seedAdjectives(catName); return; } // static, no AI
