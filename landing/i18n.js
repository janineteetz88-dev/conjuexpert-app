...
(function () {
  var I18N = {
    en: {
      ...
      "res.a": "The right verb form comes to you in conversation — no more stopping to think.", "res.b": "You speak fluently and confidently, instead of guessing and losing your thread.", "res.c": "Passive understanding turns into active speaking — in 5 languages, about your own topics.",
    ...
    es: {
      ...
      "res.a": "La forma verbal correcta te sale sola al hablar — sin pararte a pensar.", "res.b": "Hablas con fluidez y seguridad, en vez de adivinar y perder el hilo.", "res.c": "El entender pasivo se convierte en hablar activo — en 5 idiomas, sobre tus propios temas.",
    ...
    fr: {
      ...
      "res.a": "La bonne forme verbale te vient en conversation — sans plus avoir à réfléchir.", "res.b": "Tu parles avec fluidité et assurance, au lieu de deviner et de perdre le fil.", "res.c": "La compréhension passive devient une parole active — en 5 langues, sur tes propres sujets.",
    ...
    nl: {
      ...
      "res.a": "De juiste werkwoordsvorm komt vanzelf in een gesprek — geen nadenken meer.", "res.b": "Je spreekt vloeiend en zelfverzekerd, in plaats van te gokken en de draad kwijt te raken.", "res.c": "Passief begrijpen wordt actief spreken — in 5 talen, over je eigen onderwerpen.",
