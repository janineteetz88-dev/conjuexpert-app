...
(function () {
  var I18N = {
    en: {
      ...
      "hero.eyebrow": "conjugation trainer · 5 languages",
      "hero.h1": "Conjugate verbs until they <span class=\"grad-word\">click in conversation</span>.",
      "hero.lead": "Conjugate verbs and truly remember them — by actively switching languages, with sentences built from your favourite topics. All tenses, in 5 languages. Start free.",
      ...
      "pr.premLi1": "Everything in the „Free plan“ &amp;", "pr.premLi2": "Quiz — 4 modes, sentences, language switch", "pr.premLi3": "Save — favourites &amp; vocabulary lists", "pr.premBtn": "Get Premium",
      ...
      "ft.tagline": "The conjugation trainer for 5 languages — Quiz, Save &amp; Learn.",
    ...
    es: {
      ...
      "hero.eyebrow": "Entrenador de conjugación · 5 idiomas",
      "hero.h1": "Conjuga verbos hasta que te <span class=\"grad-word\">salgan al hablar</span>.",
      "hero.lead": "Conjuga verbos y recuérdalos de verdad — cambiando de idioma de forma activa, con frases sobre tus temas favoritos. Todos los tiempos, en 5 idiomas. Empieza gratis.",
      ...
      "pr.premLi1": "Todo lo del „plan Básico“ y", "pr.premLi2": "Quiz — 4 modos, frases, cambio de idioma", "pr.premLi3": "Guardar — favoritos y listas de vocabulario", "pr.premBtn": "Obtener Premium",
      ...
      "ft.tagline": "El entrenador de conjugación para 5 idiomas — Quiz, Guardar y Aprender.",
    ...
    fr: {
      ...
      "hero.eyebrow": "Entraîneur de conjugaison · 5 langues",
      "hero.h1": "Conjugue des verbes jusqu'à ce qu'ils <span class=\"grad-word\">viennent en parlant</span>.",
      "hero.lead": "Conjugue des verbes et retiens-les vraiment — en changeant activement de langue, avec des phrases tirées de tes sujets préférés. Tous les temps, en 5 langues. Commence gratuitement.",
      ...
      "pr.premLi1": "Tout du „forfait de base“ et", "pr.premLi2": "Quiz — 4 modes, phrases, changement de langue", "pr.premLi3": "Enregistrer — favoris et listes de vocabulaire", "pr.premBtn": "Obtenir Premium",
      ...
      "ft.tagline": "L'entraîneur de conjugaison pour 5 langues — Quiz, Enregistrer et Apprendre.",
    ...
    nl: {
      ...
      "hero.eyebrow": "vervoegingstrainer · 5 talen",
      "hero.h1": "Vervoeg werkwoorden tot ze <span class=\"grad-word\">komen als je praat</span>.",
      "hero.lead": "Vervoeg werkwoorden en onthoud ze echt — door actief van taal te wisselen, met zinnen uit je favoriete onderwerpen. Alle tijden, in 5 talen. Gratis beginnen.",
      ...
      "pr.premLi1": "Alles uit de „Basis“ en", "pr.premLi2": "Quiz — 4 modi, zinnen, taalwissel", "pr.premLi3": "Bewaren — favorieten en woordenlijsten", "pr.premBtn": "Premium nemen",
      ...
      "ft.tagline": "De vervoegingstrainer voor 5 talen — Quiz, Bewaren en Leren.",
