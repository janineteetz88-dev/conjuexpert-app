  ...
  const addRow = (kind) => {
    ...
    return h("div", { className: "ch-edit" },
      ...
      chips.length ? h("div", { className: "ch-from" },
        h("div", { className: "ch-from-head" },
          h("span", { className: "ch-from-lbl" }, tr("ch_from_saved")),
          chips.length > 1 ? h("button", { className: "ch-from-all", onClick: () => chips.forEach(c => add(c)) }, tr("ch_add_all")) : null),
