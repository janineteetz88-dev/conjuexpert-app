...
(function () {
  window.UI = {
    en: {
      ...
      which_tense: "Tense", tense_word: "Tense", all_tenses: "All tenses", all_themes: "All topics", which_verbs: "Words", which_dir: "Direction", dir_produce: "PRODUCE", dir_recognize: "RECOGNIZE", dir_random: "RANDOM", which_theme: "Topics", quiz_mode_hd: "Quiz mode", none_all: "None selected — all tenses are practiced", all_btn: "All", none_btn: "None", mist_clear_title: "All mistakes cleared!", mist_clear_sub: "Nice work — you reviewed every verb you got wrong.", mist_practice: "Practice mistakes", view_conj: "See full conjugation", mist_exit: "Back to all verbs",
    ...
    de: {
      ...
      which_tense: "Zeitform", tense_word: "Zeitform", all_tenses: "Alle Zeitformen", all_themes: "Alle Themen", which_verbs: "Wörter", which_dir: "Richtung", dir_produce: "PRODUZIEREN", dir_recognize: "ERKENNEN", dir_random: "ZUFÄLLIG", which_theme: "Themen", quiz_mode_hd: "Quiz-Modus", none_all: "Nichts gewählt — es werden alle Zeitformen geübt", all_btn: "Alle", none_btn: "Keine", mist_clear_title: "Alle Fehler gemeistert!", mist_clear_sub: "Stark — du hast jedes falsch gemachte Verb wiederholt.", mist_practice: "Fehler üben", view_conj: "Volle Konjugation ansehen", mist_exit: "Zurück zu allen Verben",
    ...
    fr: {
      ...
      which_tense: "Temps", tense_word: "Temps", all_tenses: "Tous les temps", all_themes: "Tous les thèmes", which_verbs: "Mots", which_dir: "Direction", dir_produce: "PRODUIRE", dir_recognize: "RECONNAÎTRE", dir_random: "ALÉATOIRE", which_theme: "Thèmes", quiz_mode_hd: "Mode quiz", none_all: "Aucun — tous les temps sont révisés", all_btn: "Tous", none_btn: "Aucun", mist_clear_title: "Erreurs maîtrisées !", mist_clear_sub: "Bravo — tu as revu chaque verbe raté.", mist_practice: "Réviser les erreurs", view_conj: "Voir la conjugaison", mist_exit: "Revenir à tous les verbes",
  ...
  if (kind === "merken") {
    return h("div", { className: "tmock", key: "mk", style: { position: "relative" } },
      h("div", { style: { fontSize: "13.5px", lineHeight: 1.6, textAlign: "left", position: "relative" } }, "No me gusta este ",
        h("b", { className: "tm-word" }, "trabajo"), " los lunes.",
        h("span", { className: "tm-tapdot", style: { left: "39%", top: "0px" } })),
...
function PricingSheet({
  ...
  }, tr("pr_premium"))), row(tr("pr_feat_conj"), true, true, true), row(tr("plan_feat3"), true, true, true), row(tr("plan_feat1"), false, tr("pr_quiz_day"), "∞"), row(tr("plan_feat2"), false, false, true), row(tr("pr_feat_goals"), false, false, true), row(tr("plan_feat4"), false, false, true)), h("p", {
