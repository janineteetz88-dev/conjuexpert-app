...
(function () {
  window.UI = {
    en: {
      ...
      which_tense: "Tense", tense_word: "Tense", all_tenses: "All tenses", all_themes: "All topics", which_verbs: "Words", which_dir: "Direction", dir_produce: "PRODUCE", dir_recognize: "RECOGNIZE", dir_random: "RANDOM", which_theme: "Topics", quiz_mode_hd: "Quiz mode", explain_hd: "Explanation", req_form: "Asked", tip_label: "Tip", none_all: "None selected — all tenses are practiced", all_btn: "All", none_btn: "None", mist_clear_title: "All mistakes cleared!", mist_clear_sub: "Nice work — you reviewed every verb you got wrong.", mist_practice: "Practice mistakes", view_conj: "See full conjugation", mist_exit: "Back to all verbs",
...
function QuizTip({ formation, irregular }) {
  const [open, setOpen] = useState(false);
  const h = React.createElement;
  if (!formation && !irregular) return null;
