...
function TourGate({
  ...
  const slides = [
    ...
    { kind: "quizmodes", title: tr("tab_quiz"), text: tr("t2_quizmodes_x") },
    { kind: "quiz", title: tr("t2_quiz_tap_t"), text: tr("t2_tap_x") },
    { kind: "type", title: tr("t2_quiz_type_t"), text: tr("t2_type_x") },
