...
function VocabView({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    /*#__PURE__*/React.createElement("button", { className: "vimp-cta", onClick: runImport, disabled: !impText.trim() }, tr("imp_cta")))), moveId && (() => {
