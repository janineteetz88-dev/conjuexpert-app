...
function PricingSheet({
  ...
  const eq = eur(A_EQ);
  const row = (label, free) => h("div", {
    className: "pr-row",
    key: label
  }, h("span", {
    className: "pr-rl"
  }, label), h("span", {
    className: "pr-rc " + (free ? "yes" : "no")
  }, free ? "✓" : "–"), h("span", {
    className: "pr-rc yes"
  }, "✓"));
  return h("div", {
    ...
    className: "pr-th-free"
  }, tr("pr_free")), h("span", {
    className: "pr-th-prem"
  }, tr("pr_premium"))), row(tr("pr_feat_conj"), true), row(tr("plan_feat3"), true), row(tr("plan_feat1"), false), row(tr("plan_feat2"), false), row(tr("plan_feat4"), false)), h("div", {
    className: "pr-plans"
  }, h("button", {
