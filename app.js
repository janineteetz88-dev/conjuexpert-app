...
function SavedTab({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: () => pick("vocab")
  }, tr("saved_vocab")), /*#__PURE__*/React.createElement("button", {
    className: "savedsubbtn" + (sub === "challenge" ? " on" : ""),
    onClick: () => pick("challenge")
  }, tr("ch_tab"))), sub === "verbs" ? /*#__PURE__*/React.createElement(SavedView, {
    lang: lang,
    favs: favs,
    toggleFav: toggleFav,
    pickVerb: pickVerb,
    onActivity: onActivity
  }) : sub === "vocab" ? /*#__PURE__*/React.createElement(VocabView, {
    lang: lang
