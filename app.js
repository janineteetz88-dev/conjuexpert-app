...
function VocabView({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, txtIco("<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><rect x='6' y='4' width='12' height='16' rx='2'/><path d='M9.5 4h5v2.4h-5z'/><path d='M9 11h6M9 15h4'/></svg>", tr("imp_open"))), showImport && /*#__PURE__*/React.createElement("div", {
    className: "vimp-bg",
    ...
    /*#__PURE__*/React.createElement("button", { className: "vimp-cta", onClick: runImport, disabled: !impText.trim() }, tr("imp_cta")))), addingCat && /*#__PURE__*/React.createElement("div", {
...
function GemerktOverview({ lang, favs, onOpenList, onVerbs, onChallenge, onNewList }) {
  const h = React.createElement;
  ...
  const [hint, setHint] = useState(() => !recall("kunju-gem-hint", false));
  function closeHint() { persist("kunju-gem-hint", true); setHint(false); }
  ...
  return h("div", { className: "view", style: { gap: 0 } },
    hint ? h("div", { className: "gm-hint" },
      h("span", { className: "gm-hint-tag" }, tr("gm_hint_tag")),
      h("span", { className: "gm-hint-ic", dangerouslySetInnerHTML: { __html: IC_INFO } }),
      h("span", { className: "gm-hint-tx", dangerouslySetInnerHTML: { __html: tr("gm_hint_tx") } }),
      h("button", { className: "gm-hint-x", onClick: closeHint, "aria-label": "OK", dangerouslySetInnerHTML: { __html: IC_X2 } })) : null,
    h("button", { className: "gm-hero", onClick: () => onOpenList("all") },
      ...
      h("span", { className: "gm-hero-cta" }, h("span", { className: "gm-hero-play", dangerouslySetInnerHTML: { __html: IC_PLAY } }), tr("gm_review_now"))),
