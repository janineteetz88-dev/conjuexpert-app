...
const IC_TRASH = "<svg viewBox='0 0 24 24' width='15' height='15' fill='none' stroke='currentColor' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><path d='M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2M6 7l1 12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1l1-12'/></svg>";
function VocabView({
  lang,
  focus,
  onListDeleted
  ...
  const [askDel, setAskDel] = useState(false);            // „Liste entfernen?"-Bestätigung
  const [nameNeeded, setNameNeeded] = useState(false);    // Chooser: Name fehlt noch
  const lchNameRef = useRef(null);
  ...
  function createEmptyList() {
    ...
    // Ohne Namen: nicht still abbrechen, sondern ins Namensfeld springen.
    if (!name) { setNameNeeded(true); if (lchNameRef.current) lchNameRef.current.focus(); return; }
    if (!customCatNames.includes(name)) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "voc-title"
  }, /*#__PURE__*/React.createElement("span", { className: "voc-title-tx" }, cat === "all" ? tr("vocab_all") : isGeneralCat(cat) ? tr("gm_words") : cat, /*#__PURE__*/React.createElement("small", null, " · ", shown.length)),
    ...
    className: "chpick",
    onClick: e => e.stopPropagation()
  }, /*#__PURE__*/React.createElement("div", { className: "chpick-hd" }, /*#__PURE__*/React.createElement("b", null, tr("gm_del_t")), /*#__PURE__*/React.createElement("button", { className: "chpick-x", "aria-label": "close", onClick: () => setAskDel(false) }, "×")), /*#__PURE__*/React.createElement("p", {
    style: { fontSize: "13.5px", lineHeight: 1.5, color: "var(--muted)", margin: "0 0 16px" }
  }, tr("gm_del_b", { n: shown.length })), /*#__PURE__*/React.createElement("div", {
    style: { display: "flex", gap: "9px" }
  }, /*#__PURE__*/React.createElement("button", {
    className: "voc-del-keep",
    onClick: () => setAskDel(false)
  }, tr("gm_del_no")), /*#__PURE__*/React.createElement("button", {
    className: "voc-del-go",
    onClick: () => { const c = cat; setAskDel(false); deleteCat(c); }
  }, tr("gm_del_yes"))))), /*#__PURE__*/React.createElement("div", {
    className: "vocadd",
    style: {
      "--lc": "var(--ink)"
    }
  ...
  }, "+ ", tr("vocab_new_cat")))), (shown.filter(it => it.term && it.trans).length > 0 || shownMist.length > 0) && /*#__PURE__*/React.createElement("div", {
  ...
  }, "\u25B6 ", tr("vocab_practice"), " ", portions > 1 ? `· ${p * 30 + 1}–${Math.min((p + 1) * 30, shown.length)}` : "")), shownMist.length > 0 && /*#__PURE__*/React.createElement("button", {
    ...
    className: "mistbtn-n"
  }, shownMist.length))), /*#__PURE__*/React.createElement("div", {
    className: "vocactions"
  }, /*#__PURE__*/React.createElement("button", {
    className: "vocsuggest",
    onClick: suggestMore,
    disabled: !!seeding
  }, /*#__PURE__*/React.createElement("span", { className: "vocact-ic", dangerouslySetInnerHTML: { __html: IC_SPARK } }), /*#__PURE__*/React.createElement("span", { className: "vocact-lb" }, seeding ? "…" : tr("voc_a_suggest"))), /*#__PURE__*/React.createElement("button", {
    className: "vocsuggest vocimport",
    onClick: () => setShowImport(true)
  }, /*#__PURE__*/React.createElement("span", { className: "vocact-ic", dangerouslySetInnerHTML: { __html: "<svg viewBox='0 0 24 24' width='18' height='18' fill='none' stroke='currentColor' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><rect x='6' y='4' width='12' height='16' rx='2'/><path d='M9.5 4h5v2.4h-5z'/><path d='M9 11h6M9 15h4'/></svg>" } }), /*#__PURE__*/React.createElement("span", { className: "vocact-lb" }, tr("voc_a_import"))), crossLangsAvail().length > 0 && /*#__PURE__*/React.createElement("button", {
    className: "vocsuggest voccross",
    onClick: () => { setCrossSrc(null); setCrossPick({}); setShowCross(true); }
  }, /*#__PURE__*/React.createElement("span", { className: "vocact-ic", dangerouslySetInnerHTML: { __html: "<svg viewBox='0 0 24 24' width='18' height='18' fill='none' stroke='currentColor' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='12' r='9'/><path d='M3 12h18M12 3c2.5 2.4 3.8 5.5 3.8 9s-1.3 6.6-3.8 9c-2.5-2.4-3.8-5.5-3.8-9S9.5 5.4 12 3z'/></svg>" } }), /*#__PURE__*/React.createElement("span", { className: "vocact-lb" }, tr("voc_a_cross")))), showCross && /*#__PURE__*/React.createElement("div", {
    className: "vimp-bg",
    ...
    /*#__PURE__*/React.createElement("div", { className: "lch-opts" },
      /*#__PURE__*/React.createElement("button", { className: "lch-opt", onClick: createEmptyList },
...
function gemerktExplainHtml() {
  const rows = [
    [IC_ACT, tr("gm_xpl_due_h"), tr("gm_xpl_due_b")],
    [IC_TARGET, tr("gm_xpl_ch_h"), tr("gm_xpl_ch_b")],
    [IC_LIST, tr("gm_xpl_lists_h"), tr("gm_xpl_lists_b")]
  ];
  return rows.map(r =>
    "<div class='gmxpl-row'><span class='gmxpl-ic'>" + r[0] + "</span>" +
    "<span class='gmxpl-tx'><b class='gmxpl-t'>" + r[1] + "</b>" +
...
function SavedCell({
  ...
  // Übersetzungsspalte ist die Muttersprache → kein Lautsprecher (nur das Lernwort
  // wird vorgelesen, siehe Lautsprecher-Knopf an der Verb-Zelle).
  if (val) return /*#__PURE__*/React.createElement("div", {
    className: "vtcell vtword vtplain"
...
function App() {
  ...
  // Nach ~30 min AKTIVER Nutzung (über alle Tage summiert) einmal um eine
  // Bewertung bitten. Bewusst kumulativ — wer nie 30 Min am Stück übt, soll
  // trotzdem irgendwann gefragt werden. Der Text sagt daher nicht „heute".
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // Trial-Ende-Nudge für Gäste WIEDERHOLT zeigen (bis ein Konto da ist),
    // aber höchstens ~1×/Tag — sanfter Retention-Hook statt einmalig.
    const tendGap = now - recall("kunju-j-tend-at", 0) > 20 * 60 * 60 * 1000;
    if (trialOver && tendGap) {
      setJourney(j => j || "tend");
  ...
  function closeJourney() {
    ...
    else if (journey === "tend") persist("kunju-j-tend-at", Date.now());
