...
const DIR=__dirname,FPS=30,SECONDS=17,N=FPS*SECONDS;
const cfgArg=process.argv[2],outName=process.argv[3]||'mistake.mp4';let cfg=null;
...
if(cfg&&cfg.mistake)await p.addInitScript(c=>{window.__M=c;},cfg.mistake);
