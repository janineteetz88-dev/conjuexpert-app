...
const MAILS = [
  ...
  },
  {
    ...
    de: { subject: "Dein 5-€-Code DANKE5 ist da 🎁", pre: "Danke für dein Feedback – dein 5-€-Rabatt aufs Jahresabo ist freigeschaltet.",
      ...
      paras: ["Hallo {{name}}, lieben Dank für dein Feedback! 💛 Das freut uns wirklich sehr und hilft uns, ConjuExpert für alle besser zu machen.", "Als Dankeschön ist dein 5-€-Code <b>DANKE5</b> freigeschaltet – ein Klick, und der Rabatt ist automatisch angewendet. Das steckt alles in Premium:"],
      features: ["🎯 Quiz – alle Modi & Sprachen, unbegrenzt", "📌 Favoriten & eigene Vokabellisten", "🌍 5 Sprachen: Deutsch · Spanisch · Englisch · Niederländisch · Französisch", "📈 Challenges & Fortschritt im Blick", "🚫 Komplett werbefrei, auf allen Geräten"],
    ...
    en: { subject: "Your €5 code DANKE5 is here 🎁", pre: "Thanks for your feedback – your €5 discount on the annual plan is unlocked.",
      ...
      paras: ["Hi {{name}}, thank you so much for your feedback! 💛 It genuinely means a lot to us and helps make ConjuExpert better for everyone.", "As a thank-you, your €5 code <b>DANKE5</b> is unlocked – one click and the discount is applied automatically. Here's everything Premium gives you:"],
      features: ["🎯 Quiz – every mode & language, unlimited", "📌 Favourites & your own vocab lists", "🌍 5 languages: German · Spanish · English · Dutch · French", "📈 Challenges & progress tracking", "🚫 Completely ad-free, on all your devices"],
    ...
    es: { subject: "Tu código de 5 € DANKE5 ya está aquí 🎁", pre: "Gracias por tu opinión: tu descuento de 5 € en el plan anual está activado.",
      ...
      paras: ["Hola {{name}}, ¡muchísimas gracias por tu opinión! 💛 Nos alegra de verdad y nos ayuda a mejorar ConjuExpert para todos.", "Como agradecimiento, tu código de 5 € <b>DANKE5</b> está activado: un clic y el descuento se aplica automáticamente. Esto es todo lo que incluye Premium:"],
      features: ["🎯 Quiz – todos los modos e idiomas, sin límite", "📌 Favoritos y tus propias listas de vocabulario", "🌍 5 idiomas: alemán · español · inglés · neerlandés · francés", "📈 Challenges y seguimiento del progreso", "🚫 Sin anuncios, en todos tus dispositivos"],
    ...
    nl: { subject: "Je code van € 5 DANKE5 is er 🎁", pre: "Bedankt voor je feedback – je korting van € 5 op het jaarabonnement staat klaar.",
      ...
      paras: ["Hoi {{name}}, heel erg bedankt voor je feedback! 💛 Dat doet ons echt goed en helpt ons om ConjuExpert voor iedereen beter te maken.", "Als bedankje staat je code van € 5 <b>DANKE5</b> klaar – één klik en de korting wordt automatisch toegepast. Dit zit er allemaal in Premium:"],
      features: ["🎯 Quiz – alle modi & talen, onbeperkt", "📌 Favorieten & je eigen woordenlijsten", "🌍 5 talen: Duits · Spaans · Engels · Nederlands · Frans", "📈 Challenges & voortgang in beeld", "🚫 Volledig advertentievrij, op al je apparaten"],
    ...
    fr: { subject: "Ton code de 5 € DANKE5 est là 🎁", pre: "Merci pour ton avis – ta réduction de 5 € sur l'abonnement annuel est débloquée.",
      ...
      paras: ["Bonjour {{name}}, un grand merci pour ton avis ! 💛 Ça nous touche vraiment et nous aide à rendre ConjuExpert meilleur pour tout le monde.", "Pour te remercier, ton code de 5 € <b>DANKE5</b> est débloqué – un clic et la réduction s'applique automatiquement. Voici tout ce que comprend Premium :"],
      features: ["🎯 Quiz – tous les modes & langues, illimité", "📌 Favoris & tes propres listes de vocabulaire", "🌍 5 langues : allemand · espagnol · anglais · néerlandais · français", "📈 Challenges & suivi de progression", "🚫 Sans aucune publicité, sur tous tes appareils"],
